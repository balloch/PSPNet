...
switch data_name
    case 'ADE20K'
        ...
        eval_list = 'list/robot_approach.txt'; %'list/ADE20K_valwrobot.txt'; %evaluation list, refer to lists in folder 'samplelist'
    ...
    case 'cityscapes'
        isVal = true;
        step = 500 %125=500/4
        data_root = '/home/balloch/Data/cityscapes'; %'/data2/hszhao/dataset/cityscapes';
        eval_list = 'list/cityscapes_val.txt';
        save_root = 'mc_result/cityscapes/val/pspnet101_503';%'mc_result/cityscapes/val/pspnet101_713/';
        model_weights = 'model/pspnet101_cityscapes.caffemodel';
        model_deploy = 'prototxt/pspnet101_cityscapes_503.prototxt';%'prototxt/pspnet101_cityscapes_713.prototxt';
        fea_cha = 19;
        base_size = 2048;
        crop_size = 473;
